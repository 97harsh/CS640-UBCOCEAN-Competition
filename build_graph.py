...
def pt2graph(wsi_h5, radius=5):         # 9:8-connect 5: 4-connect
...
h5_path = '/projectnb/cs640grp/students/hsharma/UBC_processed/test/h5_files'
save_path = '/projectnb/cs640grp/students/hsharma/UBC_processed/test/ctranspath_embed/'
